...
Begin VB.Form fProjectManagement04 
   Caption         =   "Form1"
   ClientHeight    =   7650
   ClientLeft      =   60
   ClientTop       =   345
   ...
   Begin VB.Frame fraForm 
      ...
      Begin MSComctlLib.ImageList imglstColumns 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":0000
               Key             =   ""
            EndProperty
         EndProperty
      End
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            NumListImages   =   12
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":06E4
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":0AAC
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":0E74
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":123C
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":1604
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":19CC
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":1D94
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":215C
               Key             =   ""
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":2524
               Key             =   ""
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":28EC
               Key             =   ""
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":2CB4
               Key             =   ""
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "fProjectManagement04.frx":307C
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "fProjectManagement04"
...
Private Sub ActiveGanttVBCtl1_ToolTip(ToolTipAction As ActiveGanttVB.E_TOOLTIPACTION, Caption As String, ByVal StartDate As Date, ByVal EndDate As Date, ByVal Index As Long, DisplayToolTip As Boolean)
    If ToolTipAction = TA_OVERTASK Then
        Dim lIndex As Long
        For lIndex = 1 To ActiveGanttVBCtl1.Percentages.Count
            If ActiveGanttVBCtl1.Percentages.Item(lIndex).TaskKey = ActiveGanttVBCtl1.Tasks.Item(Index).Key Then
                Caption = Caption & " (" & ActiveGanttVBCtl1.StrLib.StrFormat(ActiveGanttVBCtl1.Percentages.Item(lIndex).Percent, "0.00%") & ")"
            End If
        Next lIndex
    End If
End Sub
...
Private Sub Form_Load()
    ...
    AddTaskStyle "Tasks3", RGB(255, 255, 0), RGB(255, 255, 0)
    AddTaskStyle "Tasks4", RGB(0, 0, 0), RGB(0, 0, 0)
    AddTaskStyle "PercentageGroup1", RGB(255, 0, 0), RGB(255, 0, 0)
    ActiveGanttVBCtl1.Styles.Item("PercentageGroup1").OffsetTop = 8
    ActiveGanttVBCtl1.Styles.Item("PercentageGroup1").OffsetBottom = 6
    ActiveGanttVBCtl1.Styles.Item("PercentageGroup1").CaptionVisible = False
    ...
    ActiveGanttVBCtl1.PercentageGroups.Add "PercentageGroup1", True, "PercentageGroup1"
    
    
    
    ActiveGanttVBCtl1.Percentages.Add "LSI1", "PercentageGroup1", 0.5
    ActiveGanttVBCtl1.Percentages.Add "LSI2", "PercentageGroup1", 0.25
    ActiveGanttVBCtl1.Percentages.Add "ICCL", "PercentageGroup1", 0.56
    ActiveGanttVBCtl1.Percentages.Add "ASCGS", "PercentageGroup1", 0.78
    ActiveGanttVBCtl1.Percentages.Add "ICF", "PercentageGroup1", 0.21
    ActiveGanttVBCtl1.Percentages.Add "ICRM", "PercentageGroup1", 0.1
    ActiveGanttVBCtl1.Percentages.Add "IF", "PercentageGroup1", 0.87
    ActiveGanttVBCtl1.Percentages.Add "ICR", "PercentageGroup1", 0.5
    ActiveGanttVBCtl1.Percentages.Add "ACRMP", "PercentageGroup1", 0.85
    ActiveGanttVBCtl1.Percentages.Add "ED", "PercentageGroup1", 0.43
    ActiveGanttVBCtl1.Percentages.Add "ASCEDII", "PercentageGroup1", 0.67
    ActiveGanttVBCtl1.Percentages.Add "IP401K", "PercentageGroup1", 0.42
    ActiveGanttVBCtl1.Percentages.Add "PROC", "PercentageGroup1", 0.18
    ActiveGanttVBCtl1.Percentages.Add "IA", "PercentageGroup1", 0.34
    ActiveGanttVBCtl1.Percentages.Add "RATTTRCK", "PercentageGroup1", 0.28
    ActiveGanttVBCtl1.Percentages.Add "IEHS", "PercentageGroup1", 0.13
    ActiveGanttVBCtl1.Percentages.Add "IP", "PercentageGroup1", 0.78
    ActiveGanttVBCtl1.Percentages.Add "IPRR", "PercentageGroup1", 0.21
    ActiveGanttVBCtl1.Percentages.Add "RATTTRCK2", "PercentageGroup1", 0.1
    ActiveGanttVBCtl1.Percentages.Add "IEHS2", "PercentageGroup1", 0.87
    ActiveGanttVBCtl1.Percentages.Add "IP2", "PercentageGroup1", 0.5
    ActiveGanttVBCtl1.Percentages.Add "IPRR2", "PercentageGroup1", 0.85
    ActiveGanttVBCtl1.Percentages.Add "IMSS", "PercentageGroup1", 0.43
    ActiveGanttVBCtl1.Percentages.Add "ISSSS", "PercentageGroup1", 0.67
    ActiveGanttVBCtl1.Percentages.Add "CMSS", "PercentageGroup1", 0.42
    ActiveGanttVBCtl1.Percentages.Add "CSSSS", "PercentageGroup1", 0.18
