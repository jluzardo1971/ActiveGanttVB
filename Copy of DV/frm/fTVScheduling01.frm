    ...
    With ActiveGanttVBCtl1
        ...
        With .Styles
            ...
            With .Item("MSNBC")
                ...
                Set .ImageList = imgMSNBC
                .StartPictureIndex = 1
                .MiddlePictureIndex = 2
                .EndPictureIndex = 3
                .ForeColor = mp_ConvertColor(&H80000005)
                mp_ConvertFont .Font, E_FONTTYPES.FNT_BOLD
            End With
        ...
        .Views.Item(1).UpperTier.Interval = "1m"
        .Views.Item(1).UpperTier.Height = 17
        .Views.Item(1).LowerTier.Interval = "1d"
        .Views.Item(1).LowerTier.Height = 17
        .Views.Item(1).ToolTipsVisible = False
        ...
        End With
        mp_ConvertFont .Views.Item("1").TickMarkArea.Font, E_FONTTYPES.FNT_NORMAL
        .CurrentView = "1"
